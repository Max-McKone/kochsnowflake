...
public class Snowflake extends JApplet{
    ...
    public void init(){
        String levelStr0 = JOptionPane.showInputDialog("Enter the depth of recursion");
        String levelStr1 = JOptionPane.showInputDialog("Enter the probability:");
 
        level = Integer.parseInt(levelStr0);
        levelB = Integer.parseInt(levelStr1);
    }
